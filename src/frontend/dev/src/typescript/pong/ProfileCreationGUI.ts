	...
	connectedCallback()
	{
		...
		this.innerHTML = `
			<div class="ml-[1vw] p-[0.5vw] w-2/5 border-[0.1vw] border-black border-solid">
				<input type="text" placeholder="pseudo" class="w-full outline-none border-transparent border-solid border-b-[0.2vw] focus:border-blue-400 transition-all duration-75">
			</div>
			<input type="file" accept=".png,.jpg" class="file:bg-gray-300 file:p-[0.5vw] border-gray-300 border-[0.1vw] rounded-lg border-solid w-2/5 hover:scale-[105%] transition-all">
