...
import { isPowerOfTwo, shuffle } from "./utils.js";
export class TournamentHelper {
    static { this.maxTournamentParticipants = 64; }
    static { this.maxNameLength = 20; }
    static createQualificationMatches(participants) {
    ...
    static createTournamentMatches(profiles) {
    ...
    static createMatchesByRoundRecursive(participants) {
    ...
    static setQualifiedParticipants(qualified, participants, disqualified, expectedQualified) {
    ...
    static getExpectedQualified(participantCount) {
